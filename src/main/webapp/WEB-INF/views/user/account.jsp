        ...
        <div class="span9">
            <div class="well">
               ...
               <t:error/>
                ...
                <div class="row">
                    <div class="span8">
                        <form action="/user/account/update" method="post" class="form-horizontal">
                            <fieldset>
                ...
                <div class="row">
                    <div class="span8">
                        <sf:form action="/user/account/password" method="post" class="form-horizontal" modelAttribute="changePasswordForm">
                            ...
                            <div class="alert alert-block alert-error fade in">
                                ...
                                <div class="modal hide" id="deleteAccountLink">
                                    ...
                                    <div class="modal-footer">
                                        <form class="form-horizontal" method="post" action="/user/account/delete">
                                            <p>
